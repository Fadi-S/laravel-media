                                    ...
                                    <table width="100%" cellpadding="0" cellspacing="0" style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">
                                        ...
                                        <tr>
                                            <td class="content-block" valign="top">
                                                @lang("messages.message_why_email")
                                            </td>
                                        </tr>

                                        <tr>
                                            <td class="content-block" itemprop="handler" valign="top">
                                                <a href="{{ url(\Config::get("admin").'/reset/change/'.$token) }}" class="btn btn-primary" itemprop="url">
                                        ...
                                        <tr>
                                            <td class="content-block">
                                                @lang("messages.message_warn_email")
                                            </td>
                                        </tr>

                                        <tr>
                                            <td class="content-block" valign="top">
                                                Stgtube - Admin Dashboard
                                            </td>
                                        </tr>
